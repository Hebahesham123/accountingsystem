...
export default function PurchaseOrderReview({ purchaseOrderId, onClose }: PurchaseOrderReviewProps) {
  ...
  useEffect(() => {
    ...
    const savedOrder = savedOrders.find((order: any) => order.id === purchaseOrderId);
