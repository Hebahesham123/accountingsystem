...
DROP FUNCTION IF EXISTS update_user_profile(character varying, character varying);

-- STEP 3: Create get_current_user_profile function with flexible types
...
-- STEP 4: Create update_user_profile function with flexible types
...
BEGIN
    ...
    RAISE NOTICE '1. All required functions created with flexible column types';
